...
switch lower(command)
    ...
    case 'dump_frame'
        ...
        % argument 2 is the number of the panels
        % argument 3 is the gray scale level
        % argument 4 is the flag for the row compression
        % argument 5 to the end is the frame data
        % for example: 
        % Panel_com('dump_frame', [48, 1, 0, round(rand(1,8*48)*255)]); 
