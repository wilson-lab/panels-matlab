classdef PanelsController < handle
    ...
    methods 
        ...
        function frameCmd = getFrameCmd16(self,frame)
            ...
            %% use mex function to replace this block
%             numRowPan = numRow/16;
%             numColPan = numCol/16;
%             
%             row = [];
...
%                 for k=1:self.numSubPanel
%                     panMsg = [];
%                     for n=1:self.subPanelMsgLength
%                         for j=1:numColPan
...
%                 end
%             end
            frameOut = make_frame_vector_g4(frame);
