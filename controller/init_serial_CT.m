function result = init_serial_CT()
%This is a modified init_serial() function. Chuntao wants to use panel_com
%without running PControl.In this function, we just need to setup serial
%communication without callback function
