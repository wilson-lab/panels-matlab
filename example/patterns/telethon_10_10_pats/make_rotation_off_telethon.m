...
Patsy = [repmat([zeros(4,8), 7*ones(4,8)], 1, 6)];
...
directory_name = 'C:\MatlabRoot\Panel_controller_11_18_2009\Patterns\telethon_pats_10_9\telethon_7_24_pats';
str = [directory_name '\Pattern_rotation_off_step'];
save(str, 'pattern');
